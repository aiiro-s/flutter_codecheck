...
class _$_RepositoryOwner
  ...
  const _$_RepositoryOwner({required this.login, required this.avatar_url});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'RepositoryOwner(login: $login, avatar_url: $avatar_url)';
  }
...
abstract class _RepositoryOwner implements RepositoryOwner {
  const factory _RepositoryOwner(
      ...
      required final String? avatar_url}) = _$_RepositoryOwner;
